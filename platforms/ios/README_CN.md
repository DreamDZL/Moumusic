...
- 🔐 **账号登录** — 网易云 App 扫码登录；QQ 音乐支持 iOS 内嵌网页登录，会话仅保存到本机 Keychain
...
- 📚 **音乐库** — 本地歌单、网易云个人歌单、QQ 音乐个人歌单、我喜欢的音乐、收藏专辑、最近播放、音乐云盘
- ✏️ **歌单管理** — 网易云 / QQ 音乐在线歌单详情、添加 / 移除歌曲；本地歌单支持新建、导入、导出与删除
